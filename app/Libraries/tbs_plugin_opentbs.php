 ...
 */
define('OPENTBS_PLUGIN','App\\Libraries\\clsOpenTBS');
...
define('OPENTBS_INFO','App\\Libraries\\clsOpenTBS.Info');       // command to display the archive info
define('OPENTBS_RESET','App\\Libraries\\clsOpenTBS.Reset');      // command to reset the changes in the current archive
define('OPENTBS_ADDFILE','App\\Libraries\\clsOpenTBS.AddFile');    // command to add a new file in the archive
define('OPENTBS_DELETEFILE','App\\Libraries\\clsOpenTBS.DeleteFile'); // command to delete a file in the archive
define('OPENTBS_REPLACEFILE','App\\Libraries\\clsOpenTBS.ReplaceFile'); // command to replace a file in the archive
define('OPENTBS_EDIT_ENTITY','App\\Libraries\\clsOpenTBS.EditEntity'); // command to force an attribute
define('OPENTBS_FILEEXISTS','App\\Libraries\\clsOpenTBS.FileExists');
define('OPENTBS_GET_FILES','App\\Libraries\\clsOpenTBS.GetFiles');
define('OPENTBS_CHART','App\\Libraries\\clsOpenTBS.Chart');
define('OPENTBS_CHART_INFO','App\\Libraries\\clsOpenTBS.ChartInfo');
define('OPENTBS_DEFAULT','');   // Charset
define('OPENTBS_ALREADY_XML',false);
define('OPENTBS_ALREADY_UTF8','already_utf8');
define('OPENTBS_DEBUG_XML_SHOW','App\\Libraries\\clsOpenTBS.DebugXmlShow');
define('OPENTBS_DEBUG_XML_CURRENT','clsOpenTBS.DebugXmlCurrent');
define('OPENTBS_DEBUG_INFO','App\\Libraries\\clsOpenTBS.DebugInfo');
define('OPENTBS_DEBUG_CHART_LIST','App\\Libraries\\clsOpenTBS.DebugInfo'); // deprecated
define('OPENTBS_FORCE_DOCTYPE','App\\Libraries\\clsOpenTBS.ForceDocType');
define('OPENTBS_DELETE_ELEMENTS','App\\Libraries\\clsOpenTBS.DeleteElements');
define('OPENTBS_SELECT_SHEET','App\\Libraries\\clsOpenTBS.SelectSheet');
define('OPENTBS_SELECT_SLIDE','App\\Libraries\\clsOpenTBS.SelectSlide');
define('OPENTBS_SELECT_MAIN','App\\Libraries\\clsOpenTBS.SelectMain');
define('OPENTBS_DISPLAY_SHEETS','App\\Libraries\\clsOpenTBS.DisplaySheets');
define('OPENTBS_DELETE_SHEETS','App\\Libraries\\clsOpenTBS.DeleteSheets');
define('OPENTBS_DELETE_COMMENTS','App\\Libraries\\clsOpenTBS.DeleteComments');
define('OPENTBS_MERGE_SPECIAL_ITEMS','App\\Libraries\\clsOpenTBS.MergeSpecialItems');
define('OPENTBS_CHANGE_PICTURE','App\\Libraries\\clsOpenTBS.ChangePicture');
define('OPENTBS_COUNT_SLIDES','App\\Libraries\\clsOpenTBS.CountSlides');
define('OPENTBS_COUNT_SHEETS','App\\Libraries\\clsOpenTBS.CountSheets');
define('OPENTBS_SEARCH_IN_SLIDES','App\\Libraries\\clsOpenTBS.SearchInSlides');
define('OPENTBS_DISPLAY_SLIDES','App\\Libraries\\clsOpenTBS.DisplaySlides');
define('OPENTBS_DELETE_SLIDES','App\\Libraries\\clsOpenTBS.DeleteSlides');
define('OPENTBS_SELECT_FILE','App\\Libraries\\clsOpenTBS.SelectFile');
define('OPENTBS_ADD_CREDIT','App\\Libraries\\clsOpenTBS.AddCredit');
define('OPENTBS_SYSTEM_CREDIT','App\\Libraries\\clsOpenTBS.SystemCredit');
define('OPENTBS_RELATIVE_CELLS','App\\Libraries\\clsOpenTBS.RelativeCells');
