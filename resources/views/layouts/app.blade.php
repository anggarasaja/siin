  		...
  		<section id="top-contact" class="top-contact">
  						...
  						<ul class="contact-list">
  							<li>
  								<a class="site-name" href="/">
  									<img src="{{URL::asset('img/Logo_SIIN_white.png')}}" alt="Site Logo" style="max-width: 60px">
            ...
            <div class="col-sm-4 pull-right">
              <div class="top-social">
                <ul>
                  <li>
                    <a href="http://www.dikti.go.id/"><img src="{{URL::asset('img/kemenristekdikti_white.png')}}" alt="Site Logo" style="max-width: 50px"></a>
                  </li>
