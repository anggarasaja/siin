...
<html>
	<head>
		...
		<?php echo Html::style('css/custom-public.css');; ?>
			...
			<div class="row">
				<div class="col-xs-12">
					<div style="float:left">
						<img src="<?php echo e(URL::asset('img/kemenristekdikti.png')); ?>" id="img-head">
					</div>
		...
		<div class="container">
			<div class="col-xs-12">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="<?php echo e(url('/register')); ?>" style="border-right: 1px solid #AAA">Register</a></li>
					<?php else: ?>
